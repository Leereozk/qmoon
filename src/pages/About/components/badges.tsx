...
export const Badges = () => {
    return (
        <div className="overflow-hidden bg-neutral-950 py-16">
                ...
                <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2">
                    <div className="lg:pt-4 relative">
                        <img
                            ...
                            width={2432}
                            height={1442}
                            className="w-[48rem] max-w-none rounded-xl ring-1 shadow-xl ring-gray-400/10 sm:w-[57rem] absolute right-0 top-4"
                        />
                    </div>
