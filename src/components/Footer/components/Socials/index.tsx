...
export const Socials = () => {
    return (
        <div className="flex mt-4 sm:justify-center sm:mt-0">
            ...
            <a target="_blank" href="#" className="text-gray-500 hover:text-gray-900 dark:hover:text-white ms-5">
                <Discord className="w-4 h-4" />
                <span className="sr-only">Discord community</span>
            </a>
            <a target="_blank" href="//x.com/qmoonapp?s=21" className="text-gray-500 hover:text-gray-900 dark:hover:text-white ms-5">
